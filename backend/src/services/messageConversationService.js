...
async function listConversationsForUser(userId) {
  const result = await query(`
    SELECT
      ...
      CASE WHEN buyer.is_pro = TRUE AND buyer.pro_expires_at > NOW() THEN TRUE ELSE FALSE END AS buyer_is_pro,
      ...
      CASE WHEN seller.is_pro = TRUE AND seller.pro_expires_at > NOW() THEN TRUE ELSE FALSE END AS seller_is_pro,
