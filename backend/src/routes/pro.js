...
const profileUpdateSchema = Joi.object({
  ...
  catalog_pdf_url: Joi.string().trim().uri().allow('', null).optional(),
...
function mapProsRow(row) {
  return {
    ...
    pro_catalog_pdf_url: row.pro_catalog_pdf_url ?? null,
...
router.patch('/me', authenticate, async (req, res, next) => {
  try {
    ...
    const mapping = {
      ...
      catalog_pdf_url: 'pro_catalog_pdf_url',
