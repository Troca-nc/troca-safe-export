...
export const DEMO_ACCOUNTS: Record<DemoAccountKey, { email: string; password: string; label: string; description: string }> = {
  particulier: {
    ...
    password: 'Demo1234!',
    label: 'Particulier',
    description: 'Publier, discuter et gï¿½rer ses favoris.',
  },
  pro: {
  ...
  bon_plan: {
    ...
    password: 'Demo1234!',
    label: 'Bon plan',
    description: 'Promos, ï¿½vï¿½nements et campagnes sponsorisï¿½es.',
  },
  admin: {
    email: 'admin@demo.kalico.nc',
    password: 'Demo1234!',
    label: 'Administrateur',
    description: 'Modï¿½ration, dashboards et parcours de supervision.',
  },
}
