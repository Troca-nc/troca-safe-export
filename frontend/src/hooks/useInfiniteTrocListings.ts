...
export function useInfiniteTrocListings(filters: InfiniteTrocFilters, mode: 'list' | 'swipe' = 'list') {
  const query = useInfiniteQuery<TrocPage>({
    queryKey: ['troc.infinite', mode, filters],
