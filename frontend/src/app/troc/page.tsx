    ...
    <main className="min-h-screen bg-[var(--color-bg-page)] text-[var(--color-text-primary)]">
      ...
      <section className="mx-auto max-w-7xl px-4 pb-12">
        <div className="mb-5">
          ...
          <h2 className="mt-1 font-display text-2xl font-bold text-night">Découvrez les objets compatibles</h2>
          <p className="mt-1 text-sm text-night/55">
            Filtrez les annonces troc pour repérer rapidement les échanges possibles dans votre budget et votre zone.
          </p>
        </div>
        ...
        {marketLoading ? (
          ...
          <div className="mt-5 rounded-[1.75rem] border border-[var(--color-border)] bg-[var(--color-surface)] py-14 text-center text-night/45">
            <p className="text-sm font-semibold text-night">Aucune annonce troc trouvée pour le moment</p>
            <p className="mt-2 text-sm text-night/65">Essayez une autre catégorie, une autre commune ou un prix différent.</p>
          </div>
        )}
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12">
        <div className="mb-5">
          ...
          <h2 className="mt-1 font-display text-2xl font-bold text-night">Que vaut votre objet en troc ?</h2>
          <p className="mt-1 text-sm text-night/55">
            Sélectionnez une de vos annonces ou saisissez librement un prix de référence pour trouver 3 équivalents.
          </p>
        </div>
        ...
        <div className="rounded-[2rem] border border-[var(--color-border)] bg-[var(--color-surface)] p-5 shadow-sm">
          {isAuthenticated ? (
            ...
            <div className="mb-5 rounded-2xl border border-[#0A7EA4]/15 bg-nc-lagonLight px-4 py-3 text-sm text-night/70">
              Connectez-vous pour utiliser vos annonces avec le Trocômètre. En attendant, vous pouvez faire une saisie libre.
            </div>
          )}
