...
const demoReviews: ProPublicReview[] = [
  {
    id: 'demo-review-1',
    rating: 5,
    title: 'Tr�s pro du d�but � la fin',
    comment: 'R�ponse rapide, devis clair et suivi impeccable. On sent que tout est pens� pour rassurer le client.',
  ...
  },
  {
    ...
    comment: 'La vitrine est lisible, les produits sont bien pr�sent�s et la prise de contact est directe.',
...
const demoProfile: ProPublicProfile = {
  ...
  pro_commune: 'Dumb�a',
  pro_description:
    'Une vitrine locale pens�e pour pr�senter une activit�, envoyer des devis, prendre des rendez-vous et g�rer le suivi client sur un seul espace.',
  ...
  booking_settings: {
    is_enabled: true,
    title: 'R�server un cr�neau',
    subtitle: 'Choisissez un cr�neau, d�crivez votre besoin et recevez un retour rapide.',
    location_label: 'Point de rendez-vous',
    location_text: 'Dumb�a, Nouvelle-Cal�donie',
    instructions: 'Un cr�neau de confirmation est envoy� apr�s validation.',
    slot_duration_minutes: 30,
    advance_notice_hours: 24,
    max_days_ahead: 30,
    services: [
      { title: 'Visite technique', duration_minutes: 30, price_xpf: 0, description: '�valuation initiale sur site.', is_active: true },
      { title: 'Devis d�taill�', duration_minutes: 45, price_xpf: 2500, description: '�change complet avant lancement.', is_active: true },
    ],
    weekly_hours: [
  ...
  products: [
    ...
    },
    {
      ...
      description: 'Formule simple pour garder un suivi r�gulier sur les chantiers.',
      price_type: 'fixed',
      price_xpf: 29000,
      stock_quantity: 8,
      is_available: true,
    ...
    },
    {
      ...
      description: 'Un premier �change pour cadrer le besoin et pr�parer le devis.',
      price_type: 'on_quote',
      price_xpf: 0,
      stock_quantity: null,
      is_available: true,
  ...
  listings: [
    {
      ...
      seller_avg_response_time_label: 'R�pond en moins d1h',
    ...
    },
    {
      ...
      seller_avg_response_time_label: 'R�pond vite',
