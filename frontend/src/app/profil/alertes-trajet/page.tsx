      ...
      <div className="mx-auto max-w-4xl">
        <div className="mb-6 rounded-[2rem] border border-night/8 bg-white p-6 shadow-sm">
          ...
          <p className="mt-2 text-sm text-night/60">
            Recevez une notification dès qu'un trajet publié correspond à vos habitudes.
          </p>

          <div className="mt-6 grid gap-3 md:grid-cols-2">
            <input value={fromCommune} onChange={(e) => setFromCommune(e.target.value)} placeholder="Départ" className="input" />
            <input value={toCommune} onChange={(e) => setToCommune(e.target.value)} placeholder="Arrivée" className="input" />
