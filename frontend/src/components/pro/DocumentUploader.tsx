    ...
    <section className={`rounded-[2rem] border border-[var(--color-border)] bg-[var(--color-surface)] p-5 shadow-sm ${className}`}>
      <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <h2 className="mt-1 font-display text-2xl font-bold text-night">Déposez vos documents pour accélérer la vérification</h2>
          <p className="mt-2 text-sm text-night/60">
            RC Pro, décennale, certifications, diplômes, extrait RIDET. Les fichiers image sont compressés avant l’envoi.
          </p>
        </div>
      ...
      <div className={`mt-5 grid gap-4 ${compact ? 'lg:grid-cols-[1.1fr_0.9fr]' : 'lg:grid-cols-[1fr_1.05fr]'}`}>
        <div className="rounded-[1.5rem] border border-[var(--color-border)] bg-[var(--color-background-secondary)] p-4">
          ...
          <label className="mt-4 block space-y-2">
            <span className="text-sm font-semibold text-night">Libellé</span>
            <input
              type="text"
              value={label}
          ...
          <label className="mt-4 block space-y-2">
            ...
            />
            <p className="text-xs text-night/45">PDF, JPG, PNG ou WebP. Maximum recommandé : 10 Mo.</p>
          </label>
        ...
        <div className="rounded-[1.5rem] border border-[var(--color-border)] bg-white p-4">
          <div className="flex items-center justify-between gap-3">
            <div>
              ...
              <p className="text-sm text-night/55">Suivez l’état de chaque dépôt.</p>
            </div>
          ...
          {loading ? (
            ...
            <div className="mt-4 rounded-2xl border border-dashed border-night/12 bg-sand/20 p-5 text-sm text-night/55">
              ...
              <p className="mt-1 text-sm text-night/55">Déposez un premier justificatif pour lancer la vérification.</p>
            </div>
          ) : (
