...
const PRIMARY_CATEGORY_ITEMS = [
  ...
  { slug: 'electronique-multimedia', label: 'Ãlectronique' },
  ...
  return (
    <section className="mx-auto max-w-7xl px-4 pb-12">
      <div className="mb-5 flex items-end justify-between gap-4">
        <div>
          <p className="text-sm font-semibold uppercase tracking-[0.22em] text-nc-lagon">CatÃ©gories principales</p>
          <h2 className="mt-1 font-display text-2xl font-bold text-night">AccÃ©dez vite aux rayons les plus utiles</h2>
        </div>
