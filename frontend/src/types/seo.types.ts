...
export const CATEGORIES_SEO: Record<string, { label: string; description: string; emoji: string }> = {
  ...
  location_courte_duree: {
    label: 'Locations courte durée',
    description: 'Locations saisonnières, bungalows et séjours courts en NC',
    emoji: '🏖️',
  },
  ...
  services: { label: 'Services', description: 'Prestations de services en Nouvelle-Calédonie', emoji: '🛠️' },
